...
(6, 2), 'Star Boys hostel', 'Near BBD University, Chinhat, Faizabad Road, Lucknow - 226010','Furnished studio apartment - share it with close friends! Located in posh area of Chinhat in Lucknow, this house is available for only boys. Go for a private room or opt for a shared one and make it your own abode. Go out with your new friends - catch a movie at the nearest cinema hall or just chill in a cafe which is not even 2 kms away. After all, there\'s always a Joey with unlimited supply of food. Remember, all it needs is one crazy story to convert a roomie into a BFF.  What\'s nearby/Your New Neighborhood 7.0 Kms from - Indrra Nagar Metro Station.', 'male', 5000, 4.3, 3.4, 4.8);
-- --------------------------------------------------------
